# -*- coding: utf-8 -*-
"""DeepSeek Provider - DeepSeek API 支持
...
class DeepSeekProvider(LLMProvider):
    ...
    def base_url(self) -> str:
        return self.config.base_url or "https://api.deepseek.com"
    
    async def initialize(self):
        """初始化 DeepSeek 客户端"""
        if not self.config.api_key:
            raise ValueError("DeepSeek API key is required. Set DEEPSEEK_API_KEY env variable.")
